...
func checkColumn(t, c string) error {
	initCheck.Do(func() {
		columnCheck = sql.NewColumnCheck(map[string]func(string) bool{
			...
			globalsetting.Table:    globalsetting.ValidColumn,
			group.Table:            group.ValidColumn,
			groupmember.Table:      groupmember.ValidColumn,
			host.Table:             host.ValidColumn,
			hostmac.Table:          hostmac.ValidColumn,
			image.Table:            image.ValidColumn,
			imagetype.Table:        imagetype.ValidColumn,
			imaginglog.Table:       imaginglog.ValidColumn,
			inventory.Table:        inventory.ValidColumn,
			module.Table:           module.ValidColumn,
			modulestatus.Table:     modulestatus.ValidColumn,
			multicastsession.Table: multicastsession.ValidColumn,
			ostype.Table:           ostype.ValidColumn,
			pendingmac.Table:       pendingmac.ValidColumn,
			printer.Table:          printer.ValidColumn,
			printerassoc.Table:     printerassoc.ValidColumn,
			refreshtoken.Table:     refreshtoken.ValidColumn,
			scheduledtask.Table:    scheduledtask.ValidColumn,
			snapin.Table:           snapin.ValidColumn,
			snapinassoc.Table:      snapinassoc.ValidColumn,
			snapinjob.Table:        snapinjob.ValidColumn,
			snapintask.Table:       snapintask.ValidColumn,
			storagegroup.Table:     storagegroup.ValidColumn,
			storagenode.Table:      storagenode.ValidColumn,
