...
func (_c *UserCreate) SetAPIToken(v string) *UserCreate {
	_c.mutation.SetAPIToken(v)
	return _c
}

// SetNillableAPIToken sets the "api_token" field if the given value is not nil.
func (_c *UserCreate) SetNillableAPIToken(v *string) *UserCreate {
	if v != nil {
		_c.SetAPIToken(*v)
	}
	return _c
...
// SetAPIToken sets the "api_token" field.
func (u *UserUpsert) SetAPIToken(v string) *UserUpsert {
	u.Set(user.FieldAPIToken, v)
	return u
}

// UpdateAPIToken sets the "api_token" field to the value that was provided on create.
func (u *UserUpsert) UpdateAPIToken() *UserUpsert {
	u.SetExcluded(user.FieldAPIToken)
	return u
}
...
// SetAPIToken sets the "api_token" field.
func (u *UserUpsertOne) SetAPIToken(v string) *UserUpsertOne {
	return u.Update(func(s *UserUpsert) {
		s.SetAPIToken(v)
	})
}
...
// UpdateAPIToken sets the "api_token" field to the value that was provided on create.
func (u *UserUpsertOne) UpdateAPIToken() *UserUpsertOne {
	return u.Update(func(s *UserUpsert) {
		s.UpdateAPIToken()
	})
}
...
// SetAPIToken sets the "api_token" field.
func (u *UserUpsertBulk) SetAPIToken(v string) *UserUpsertBulk {
	return u.Update(func(s *UserUpsert) {
		s.SetAPIToken(v)
	})
}
...
// UpdateAPIToken sets the "api_token" field to the value that was provided on create.
func (u *UserUpsertBulk) UpdateAPIToken() *UserUpsertBulk {
	return u.Update(func(s *UserUpsert) {
		s.UpdateAPIToken()
	})
}
