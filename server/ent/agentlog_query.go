...
func (_q *AgentLogQuery) QueryTask() *TaskQuery {
...
func (_q *AgentLogQuery) QueryHost() *HostQuery {
...
func (_q *AgentLogQuery) FirstID(ctx context.Context) (id uuid.UUID, err error) {
	var ids []uuid.UUID
...
func (_q *AgentLogQuery) FirstIDX(ctx context.Context) uuid.UUID {
...
func (_q *AgentLogQuery) OnlyID(ctx context.Context) (id uuid.UUID, err error) {
	var ids []uuid.UUID
...
func (_q *AgentLogQuery) OnlyIDX(ctx context.Context) uuid.UUID {
...
func (_q *AgentLogQuery) IDs(ctx context.Context) (ids []uuid.UUID, err error) {
...
func (_q *AgentLogQuery) IDsX(ctx context.Context) []uuid.UUID {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *AgentLogQuery) WithTask(opts ...func(*TaskQuery)) *AgentLogQuery {
	query := (&TaskClient{config: _q.config}).Query()
...
func (_q *AgentLogQuery) WithHost(opts ...func(*HostQuery)) *AgentLogQuery {
	query := (&HostClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *AgentLogQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*AgentLog, error) {
	...
	if query := _q.withTask; query != nil {
		if err := _q.loadTask(ctx, query, nodes, nil,
			func(n *AgentLog, e *Task) { n.Edges.Task = e }); err != nil {
			return nil, err
		}
	}
	if query := _q.withHost; query != nil {
		if err := _q.loadHost(ctx, query, nodes, nil,
			func(n *AgentLog, e *Host) { n.Edges.Host = e }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *AgentLogQuery) loadTask(ctx context.Context, query *TaskQuery, nodes []*AgentLog, init func(*AgentLog), assign func(*AgentLog, *Task)) error {
	ids := make([]uuid.UUID, 0, len(nodes))
	nodeids := make(map[uuid.UUID][]*AgentLog)
	for i := range nodes {
		fk := nodes[i].TaskID
...
func (_q *AgentLogQuery) loadHost(ctx context.Context, query *HostQuery, nodes []*AgentLog, init func(*AgentLog), assign func(*AgentLog, *Host)) error {
	ids := make([]uuid.UUID, 0, len(nodes))
	nodeids := make(map[uuid.UUID][]*AgentLog)
	for i := range nodes {
		fk := nodes[i].HostID
...
func (_q *AgentLogQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(agentlog.Table, agentlog.Columns, sqlgraph.NewFieldSpec(agentlog.FieldID, field.TypeUUID))
	_spec.From = _q.sql
	...
	if fields := _q.ctx.Fields; len(fields) > 0 {
		...
		if _q.withTask != nil {
			_spec.Node.AddColumnOnce(agentlog.FieldTaskID)
		}
		if _q.withHost != nil {
			_spec.Node.AddColumnOnce(agentlog.FieldHostID)
		}
	}
