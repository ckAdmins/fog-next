...
func (*User) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case user.FieldUsername, user.FieldPasswordHash, user.FieldRole, user.FieldEmail, user.FieldAPIToken, user.FieldCreatedBy:
...
func (_m *User) NamedRefreshTokens(name string) ([]*RefreshToken, error) {
...
func (_m *User) appendNamedRefreshTokens(name string, edges ...*RefreshToken) {
	if _m.Edges.namedRefreshTokens == nil {
		_m.Edges.namedRefreshTokens = make(map[string][]*RefreshToken)
	}
	if len(edges) == 0 {
		_m.Edges.namedRefreshTokens[name] = []*RefreshToken{}
	} else {
